...
{
    // values[0]=screenW, values[1]=screenH, values[2]=ratio, values[3](可选)=scale
    public class CenterLeftConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            double left = screenW * ratio - size / 2.0;
