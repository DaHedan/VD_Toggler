...
_为触屏制作的虚拟桌面UI工具 _ - 无需键盘即可轻松使用 Windows 虚拟桌面（支持 Win10/11 x64）
## 🗂️ 文件说明
...
__VD_Toggler v2.0:__  
安装包：[VD_Toggler_2.0_x64_Setup.exe](https://github.com/DaHedan/VD_Toggler/releases/download/v2.0.0/VD_Toggler_2.0_x64_Setup.exe)

__其他版本：__  
[VD_Toggler v2.1.1-beta](https://github.com/DaHedan/VD_Toggler/releases/tag/v2.1.1-beta)